...
export const RoundHeaderSVG: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="60vw" height="60" viewBox="0 0 955 60" fill="none" {...props}>
        <path d="M52.5 0H955V60L0 59V51L52.5 0Z" fill="#000" stroke="white" strokeWidth="1" />
    </svg>
);

export const RoundBackgroundSVG: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg width="957" height="321" viewBox="0 0 957 321" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
        <path d="M0.5 320.5V51.7099L52.7043 0.5H956.5V269.291L904.794 320.5H477.796H0.5Z" fill="#202020" stroke="white" strokeWidth="1" />
    </svg>
);

export const ProfileBackgroundSVG: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg width="352" height="702" viewBox="0 0 352 702" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
